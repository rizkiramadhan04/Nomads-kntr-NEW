...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('backend/AdminLTE-3.2.0/plugins/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  <!-- Theme style -->
...
<!-- jQuery -->
<script src="{{ asset('backend/AdminLTE-3.2.0/plugins/jquery/jquery.min.js') }}../../plugins/"></script>
<!-- Bootstrap 4 -->
